...
| 4.1.5 Compras | Operable | Fila DESCONGELADA 2026-08-28: llevaba desde PR #32 sin actualizar. Proveedores (#32), ordenes de compra (#34), recepcion (#36, #39), facturas y pagos de proveedor (#41), productos del proveedor (#42-#43), costeo (#45-#46). Sin cuentas por pagar como REPORTE de antiguedad (candidato 4.1.9); GET /suppliers/{uuid}/balance existe |
