...
| 4.1.3 Catalogo | Operable | Unidades e impuestos con apiResource completo (ya existia; la matriz lo reportaba mal). Sin variantes, combos, kits, recetas, promociones, cupones, listas de precios, precios programados (DIFERIBLE). Productos por peso OPERABLES en backend desde #50 (1ebc2b8): gate allow_decimals, quantity_source, captura manual con sale.weight.manual; la bascula la lee la terminal (48.4) |
...
| 4.1.5 Compras | Operable | Fila DESCONGELADA 2026-08-28: llevaba desde PR #32 sin actualizar. Proveedores (#32), ordenes de compra (#34), recepcion (#36, #39), facturas y pagos de proveedor (#41), productos del proveedor (#42-#43), costeo (#45-#46). Reporte de antiguedad de pagables entregado en #52 (157d663, ver 4.1.9); GET /suppliers/{uuid}/balance existe |
| 4.1.6 Ventas | Operable | Checkout, pagos multiples, cancelacion, devoluciones. Granel #50; cobro con terminal bancaria modelo A cerrado en #51 (add1d46): authorization_code obligatorio en tarjeta, corte separa efectivo. Modelo B (SDK) fase posterior. Sin apartados, cotizaciones, gift cards, vales, propinas, comisiones, multiples carritos, suspension de venta (DIFERIBLE) |
...
| 4.1.9 Reportes | Operable | 10 endpoints (margen real por producto en #49; antiguedad de cuentas por pagar en #52, 157d663). Productos sin venta y diferencias de caja cerrados en PR #27. Resto del bloque analitico y contable DIFERIBLE |
