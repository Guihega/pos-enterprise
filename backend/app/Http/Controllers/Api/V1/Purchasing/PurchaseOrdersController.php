 ...
 *
 * Entrega actual: crear, listar, ver, submit, approve, cancel.
 * DIFERIDOS: PATCH de la OC en draft y POST /receive. El segundo mueve stock
 * via InventoryService y va en su propia entrega con sus tests.
 *
